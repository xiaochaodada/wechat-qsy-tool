    ...
    q != T && 0 != D && (q != b ? q != H ? q != k || function() {
        ...
        if (1 == g) {
            ...
            if (1 == t.gotDianzhen) {
                ...
                w.push("\n");
                for (var C = 0; C < 16; C++) {
                    for (var n = Math.round(15 * C / 15), o = "", D = 0, S = 0; S < 43; S++) D >= S + 1 || (D <= S - 1 && (o += x,
                        D += 1), l = Math.round(15 * S / 42), 1 == (1 != r[n][l]) ? (o += x, D += 1) : (o += y,
                        D += p, m = !1));
                    o += "\n", w.push(o);
                }
        ...
        success: function(e) {
            if (0 != D) {
                for (var t = !0, a = new Array(), r = 0, n = 0, o = 0; o < 18; o++) {
                    ...
                    for (var s = Math.round(59 * o / 17), h = "", i = 0, d = 0; d < 43; d++)
                        if (!(i >= d + 1)) {
                            i <= d - 1 && (h += x, i += 1);
                            var l, _, v, m, w, C, g = Math.round(59 * d / 42);
                            if (o > 0 && o < 17) {
...
var s, h, i, d, l, u, c, f, p, _, v = require("hanzi_dianzhen_container.js"),
    m = require("common.js"),
    w = require("width_const.js"),
    C = (getApp(), ["🌸", "🌺", "🌹", "🌷", "💑", "🙃", "😎", "💏", "🐶", "🐷", "🍁", "🔥", "🍎", "🍓", "🍅", "💖"]),
    g = !0,
    D = !1,
    S = !1,
...
Page({
    ...
    covertCoreDataToCopyed: function() {
        for (var e = "\n", t = 0; t < s.length; t++)
            for (var a = 0; a < s[t].length; a++) e += s[t][a];
        return e;
    },
