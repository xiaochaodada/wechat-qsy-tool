...
!function(t, r) {
    "object" === ("undefined" == typeof exports ? "undefined" : e(exports)) && "undefined" != typeof module ? module.exports = r() : "function" == typeof define && define.amd ? define(r) : (void 0).drawQrcode = r();
}(0, function() {
    function t(t) {
    ...
    t.prototype = {
        ...
        setupTypeNumber: function(t) {
            for (var e = h.getBCHTypeNumber(this.typeNumber), r = 0; r < 18; r++) o = !t && 1 == (e >> r & 1), 
        ...
        setupTypeInfo: function(t, e) {
            for (var r = this.errorCorrectLevel << 3 | e, o = h.getBCHTypeInfo(r), n = 0; n < 15; n++) i = !t && 1 == (o >> n & 1), 
        ...
        for (;!(u.getLengthInBits() >= 8 * l) && (u.put(e.PAD0, 8), !(u.getLengthInBits() >= 8 * l)); ) u.put(e.PAD1, 8);
        ...
        for (var o = 0, n = 0, i = 0, a = new Array(e.length), u = new Array(e.length), s = 0; s < e.length; s++) {
            ...
            for (n = Math.max(n, f), i = Math.max(i, l), a[s] = new Array(f), v = 0; v < a[s].length; v++) a[s][v] = 255 & t.buffer[v + o];
            o += f;
            var g = h.getErrorCorrectPolynomial(l), c = new r(a[s], g.getLength() - 1).mod(g);
            for (u[s] = new Array(g.getLength() - 1), v = 0; v < u[s].length; v++) {
                var d = v + c.getLength() - u[s].length;
                u[s][v] = d >= 0 ? c.get(d) : 0;
            }
        }
        for (var m = 0, v = 0; v < e.length; v++) m += e[v].totalCount;
        for (var C = new Array(m), p = 0, v = 0; v < n; v++) for (s = 0; s < e.length; s++) v < a[s].length && (C[p++] = a[s][v]);
        for (v = 0; v < i; v++) for (s = 0; s < e.length; s++) v < u[s].length && (C[p++] = u[s][v]);
        return C;
    };
    for (var a = {
        MODE_NUMBER: 1,
