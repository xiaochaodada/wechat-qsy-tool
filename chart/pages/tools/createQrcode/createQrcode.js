...
Page({
    ...
    onShow: function(e) {
        ...
        "" == o.text && (o.text = "实用工具大全"), (0, t.default)({
            width: n.width,
            height: n.height,
            canvasId: n.id,
            text: o.text,
    ...
    createQrcode: function(e) {
        var a = this, o = e.detail.value.canvasWidth, n = a.data.QrcodeInfo, d = a.data.canvasInfo, i = e.detail.value.text;
        check.checktext(i,function () {
