...
Page({
    ...
    toSplic: function () {
        ...
        // console.log(this.progress1.getScore())
        //关闭更新所有配置
        var e = this,
            t = e.data.low,
            o = e.data.heigh,
        ...
        o - t <= 1 ? wx.showToast({
            ...
            content: "您确定要视频的" + t + "到" + o + "秒,转为GIF图片？",
            success: function (t) {
                t.confirm && e.login();
            }
        })
            ...
            wx.request({
                ...
                success: function (res) {
                    ...
                    if (res.statusCode == 200 || res.statusCode == 201) {
                        ...
                        cache.record(res.data.result.id, 9, (json_upload_data.duration).toFixed(2), (json_upload_data.size / 1024 / 1024).toFixed(2), res.data.result.created_at, res.data.result.expired_at)
